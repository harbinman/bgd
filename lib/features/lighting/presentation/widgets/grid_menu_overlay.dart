            ...
            Align(
              ...
              child: GestureDetector(
                ...
                child: Transform.translate(
                  ...
                  offset: Offset(
                      0,
                      _slideAnimation.value * screenHeight * 0.75 +
                          _dragOffset),
                  child: Transform.scale(
                    scaleY: _liquidWobble.value,
                    alignment: Alignment.topCenter,
                    child: Container(
                      height: screenHeight * 0.82, // 从 0.78 增加到 0.82
                      width: double.infinity,
                      padding: const EdgeInsets.fromLTRB(
                          28, 40, 28, 20), // 顶部从50减到40
                      ...
                      child: Column(
                        children: [
                          ...
                          AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              color: Colors.white
                                  .withOpacity(_isDragging ? 0.4 : 0.2),
